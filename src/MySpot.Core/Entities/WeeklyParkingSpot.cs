...
namespace MySpot.Core.Entities
{
    public class WeeklyParkingSpot
    {
        ...
        public static WeeklyParkingSpot Create(ParkingSpotId parkingSpotId, Week week, ParkingSpotName parkingSpotName)
            => new(parkingSpotId, week, parkingSpotName, ParkingSpotMaximumCapacity);
