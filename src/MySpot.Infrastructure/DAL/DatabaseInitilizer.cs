...
internal sealed class DatabaseInitilizer : IHostedService
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        var weeklyParkingSpots = new List<WeeklyParkingSpot>()
            {
                new (Guid.Parse("00000000-0000-0000-0000-000000000001"), new(_clock.Current()), "P1"),
                new (Guid.Parse("00000000-0000-0000-0000-000000000002"), new(_clock.Current()), "P2"),
                new (Guid.Parse("00000000-0000-0000-0000-000000000003"), new(_clock.Current()), "P3"),
                new (Guid.Parse("00000000-0000-0000-0000-000000000004"), new(_clock.Current()), "P4"),
                new (Guid.Parse("00000000-0000-0000-0000-000000000005"), new(_clock.Current()), "P5"),
            };
